...
public class AgregarEmpleado extends javax.swing.JFrame {
    protected Empleado nuevo;
    protected Supermercado mercado= new Supermercado();
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String posicion = jTextField4.getText();
        double salario = Double.parseDouble(jTextField5.getText());
        nuevo = new Empleado(cedula, nombre, departamento, posicion, salario);
        mercado.getEmpleados().add(nuevo);
        this.dispose();
